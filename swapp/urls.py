...
urlpatterns = [
    ...
    path('users/<str:username>/delete', views.users.delete_user_request, name='delete_user'),
    path('users/<str:username>/change_password', views.users.change_password_request, name='change_password'),
    path('users/<str:username>/update_profile', views.users.update_profile_request, name='update_profile'),
    ...
    path('users/<str:username>/swapp_requests/<str:trace_id>/delete_swapp_request', views.users.delete_swapp_request, name='delete_swapp_request'),
    ...
    path('items/<uuid:item_id>/update_item', views.items.update_item_request, name='update_item'),
